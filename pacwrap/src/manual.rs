...
fn ascertain_help<'a>(args: &mut Arguments) -> Result<(IndexSet<&'a HelpTopic>, &'a HelpLayout), Error> {
    ...
    while let Some(arg) = args.next() {
        match arg {
            ...
            | Operand::Value("V") => topic.push(&HelpTopic::Version),
...
This document was generated by the {name} binary with version {} of the program.\n",
    ...
    writeln!(
        buf,
        "{head}NAME{reset}
{sub_head}pacwrap.yml{reset_bold} - pacwrap configuration file.
{sub_head}repositories.conf{reset_bold} - pacman repository file.

{head}SYNOPSIS{reset}
{sub_head}~/.config/pacwrap/pacwrap.yml{reset_bold}
{sub_head}~/.config/pacwrap/repositories.conf{reset_bold}
...
{sub}Repository configuration is parsed using {bold}pacman.conf{reset_bold}(5)'s ini format. All other options related the
...
{head}SECTIONS{reset}
{sub_head}config:{reset_bold}
{sub}{tab}Configuration pertaining to {bold}pacwrap{reset_bold}(1) are to be declared within this section.

{sub_head}alpm:{reset_bold}
{sub}{tab}Configuration pertaining to {bold}libalpm{reset_bold}(3) are to be declared within this section.

{head}CONFIG{reset}
{sub_head}logging{reset_bold}: Basic
...
{sub_head}summary{reset_bold}: Basic
...
{sub_head}progress:{reset_bold}
{tab}{tab}Progress types are declared within this subsection.

{head}PROGRESS{reset}
{sub_head}transact{reset_bold}: CondensedForeign
...
{sub_head}download{reset_bold}: Verbose
...
{sub_head}sig_level_local{reset_bold}: Optional
...
{sub_head}check_space{reset_bold}: true
...
{sub_head}download_timeout{reset_bold}: true
...
{sub_head}parallel_downloads{reset_bold}: 1
...
{sub}This program may be freely redistributed under the
...
{head}SYNOPSIS{reset}
{tab}pacwrap [{bold}OPERATION{reset_bold}] [{bold}ARGUMENTS{reset_bold}] [{bold}TARGETS{reset_bold}]	

{head}DESCRIPTION{reset}
{tab}A package management front-end which utilises libalpm to facilitate the creation of unprivileged, 
...
{sub}This application is designed to allow for the creation and execution of secure, replicable 
...
{sub_head}-a, --all, --help=all{reset_bold}
...
{sub_head}-f, --filesystem{reset_bold}
...
{sub_head}-a, --aggegrate{reset_bold}
...
fn version(buf: &mut String, layout: &HelpLayout) -> Result<(), std::fmt::Error> {
    ...
    writeln!(
        buf,
        "{head}VERSION{reset}
{sub_head}-V, --version, --version=min{reset_bold}
...
[0m[38;2;90;80;57mP[0m[38;2;226;201;137mC[0m[38;2;226;201;137mC[0m[38;2;226;202;137mC[0m[38;2;237;222;85m#[0m[38;2;249;243;29m#[0m[38;2;255;255;1m#[0m[38;2;255;255;0m#[0m[38;2;255;255;0m#[0m[38;2;255;255;0m#[0m[38;2;255;255;0m#[0m[38;2;255;255;0m#[0m[38;2;255;255;0m#[0m[38;2;255;255;0m#[0m[38;2;255;255;0m#[0m[38;2;255;255;1m#[0m[38;2;246;238;51m#[0m[38;2;231;209;138m#[0m[38;2;230;206;146mC[0m[38;2;230;206;146mC[0m[38;2;230;206;146mC[0m[38;2;230;206;146mC[0m[38;2;230;206;146mC[0m[38;2;230;206;146mC[0m[38;2;230;205;144mC[0m[38;2;230;202;139mC[0m[38;2;230;202;139mC[0m[38;2;230;202;139mC[0m[38;2;230;202;139mC[0m[38;2;230;202;139mC[0m[38;2;230;202;139mC[0m[38;2;230;202;139mC[0m[38;2;230;202;139mC[0m[38;2;230;202;139mC[0m[38;2;230;202;139mC[0m[38;2;230;202;139mC[0m[38;2;230;202;139mC[0m[38;2;230;202;139mC[0m[38;2;230;202;139mC[0m[38;2;230;202;139mC[0m[38;2;230;202;139mC[0m[38;2;230;202;139mC[0m[38;2;230;202;139mC[0m[38;2;216;190;129mC[0m[38;2;169;148;99mA[0m[38;2;66;59;39mA[0m	{version}
