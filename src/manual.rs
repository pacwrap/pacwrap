...
{sub_text}Change output format of help in {bold}STDOUT{reset_bold}. Format options include: 'ansi', 'dumb', 'markdown', and 'man'. 
...
{sub_text}Synchronize remote package databases. Specify up to 2 times to force a refresh.

{sub}-u, --upgrade{reset_bold}
{sub_text}Execute aggregate upgrade routine on all or specified containers. Use {bold}-t, --target=TARGET{reset_bold} to limit
...
{sub_text}Force execution of filesystem synchronization target on all or specified containers. In combination
...
{sub_text}Create a container with the first specified target. A container type argument is also required.

{sub}-b, --base{reset_bold}
{sub_text}Base container type. Specify alongside {bold}-c, --create{reset_bold} to assign this container type during creation.
...
{sub_text}Slice container type. Specify alongside {bold}-c, --create{reset_bold} to assign this container type during creation.
...
{sub}-r, --root{reset_bold}
{sub_text}Root container type. Specify alongside {bold}-c, --create{reset_bold} to this assign container type during creation.
...
{sub_text}Apply specified operation on the specified target only.

{sub}--force-foreign{reset_bold}
{sub_text}Force synchronization of foreign packages on resident container. Useful for when installing 
...
{sub_text}Sends version information to {bold}STDOUT{reset_bold} with colourful ASCII art. 
