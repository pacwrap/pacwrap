...
{sub_text}Change output format of help in STDOUT. Format options include: 'ansi', 'dumb', 'markdown', and 'man'. 
{tab}This option is for the express purposes of generating documentation at build time, and has little utility
{tab}outside the context of package maintenance. --format=man presently requires go-md2man to parse output.
