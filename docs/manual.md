...
This document was generated by the pacwrap binary with version 0.8.7-c65110f-DEV (11/02/2025 19:40:04-05:00) of the program.
...
#### **-d, --desktop**
Manage desktop files associated with pacwrap containers.
...
Create desktop file at `$HOME/.local/share/applications/` launching an associated container with pacwrap.

#### **-l, --list** <**CONTAINER**>
Enumerate available desktop files in the container root located at `/usr/share/applications/`
...
#### **-f, --find** <**PREDICATE**>
Filter desktop list enumeration based on a **predicate**.

### **EXAMPLES**
#### `$ pacwrap desktop list firefox`
Print tabulation of desktop files in the `firefox` container root.

#### `$ pacwrap desktop list --find libreoffice`
Tabulate all entries with the predicate `libreoffice` from `$HOME/.local/share/applications/`.

#### `$ pacwrap desktop create firefox firefox`
Install desktop file from the contaienr root into `$HOME/.local/share/applications/`.
...
Copyright (C) 2024-2025 Pacwrap Contributors

To find a current list of contributors, visit the following link:
https://github.com/pacwrap/pacwrap/graphs/contributors
